...
tank_volume = 4.5/1000;%4.5/1000;     %Volume in Litres? to be checked    
...
initial_tank_pressure = -1000000;  %set to -1000000 if unknown
tank_fluid_temperature_K = 15+273.15; %set to -1000000 if unknown

if (initial_tank_pressure ~= -1000000)
        tank_fluid_temperature_K = ...
            nox_on_press(initial_tank_pressure, nox_prop); 
elseif (tank_fluid_temperature_K ~= -1000000)
